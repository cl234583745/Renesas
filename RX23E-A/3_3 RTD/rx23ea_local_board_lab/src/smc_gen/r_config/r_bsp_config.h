...
*/
#define BSP_CFG_MCU_PART_MEMORY_SIZE    (0x6) /* Generated value. Do not edit this manually */

/* Group name.
   Character(s) = Description
   3E           = RX23E Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX23E-A" /* Generated value. Do not edit this manually */

...
src/smc_gen/Config_TMR0_TMR1/%.obj: ../src/smc_gen/Config_TMR0_TMR1/%.c src/smc_gen/Config_TMR0_TMR1/Compiler.sub
	@echo 'Scanning and building file: $<'
	@echo src\smc_gen\Config_TMR0_TMR1\cDepSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\Config_TMR0_TMR1\cDepSubCommand.tmp"
	ccrx -subcommand="src\smc_gen\Config_TMR0_TMR1\cDepSubCommand.tmp" -output=dep="$(@:%.obj=%.d)" -MT="$(@:%.d=%.obj)" -MT="$(@:%.obj=%.d)" "$<"
	@echo src\smc_gen\Config_TMR0_TMR1\cSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\Config_TMR0_TMR1\cSubCommand.tmp"

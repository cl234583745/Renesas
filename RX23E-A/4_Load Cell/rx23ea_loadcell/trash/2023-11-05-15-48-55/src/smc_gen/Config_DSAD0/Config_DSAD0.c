...
void R_Config_DSAD0_Create(void)
{
    ...
    AFE.DS00ISR.WORD = _0001_AFE_POSIN_SIGNAL_AIN1 | _0000_AFE_NEGIN_SIGNAL_AIN0 | _0000_AFE_POSBUF_REF_DISABLE | 
                       _0000_AFE_NEGBUF_REF_DISABLE | _0800_AFE_REFVOL_REF0P_REF0N;

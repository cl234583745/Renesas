...
Macro definitions
***********************************************************************************************************************/
#define _0013_DSAD0_OPERATE_CLK_WAIT_COUNT              (0x0013U) /* DSAD0 operation clock wait count */
#define _001F_DSAD0_SYNCST_WAIT_COUNT                   (0x001FU) /* DSAD0 synchronization wait count */
#define _0A01_DSAD0_STARTUP_WAIT_COUNT                  (0x0A01U) /* DSAD0 start-up wait count */
#define _0004_DSAD0_STOP_WAIT_COUNT                     (0x0004U) /* DSAD0 stop wait count */
...
void R_Config_DSAD0_Create_UserInit(void);

...
Macro definitions
***********************************************************************************************************************/
#define _DB_DMAC0_ACTIVATION_SOURCE                             (0xDBU) /* Activation source select */
#define _0008A025_DMAC0_SRC_ADDR                                (0x0008A025UL) /* Source address */
...
#define _0009_DMAC0_DST_EXT_RPT_AREA                            (0x0009U) /* Destination address extended repeat area */
 ...
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * Function Name: R_DMAC0_GetDestAddr
 * Description  : This function Get DMAC0 destination address
 * Arguments    : None
 * Return Value : void *
 *                    DMAC0 destination address pointer
 *********************************************************************************************************************/
#define R_DMAC0_GetDestAddr()                                   (DMAC0.DMDAR)

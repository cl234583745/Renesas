...
{ .pin_select = (uint8_t) (IOPORT_EVENT_PIN_SELECTION_NONE), .operation = IOPORT_EVENT_OUTPUT_OPERATION_LOW },
  ...
  { .event_control = IOPORT_EVENT_CONTROL_ENABLE, .direction = IOPORT_EVENT_DIRECTION_INPUT, .port_num =
            (uint16_t) BSP_IO_PORT_16_PIN_6,
    .operation = IOPORT_EVENT_OUTPUT_OPERATION_LOW, .edge_detection = IOPORT_EVENT_DETECTION_FALLING_EDGE },

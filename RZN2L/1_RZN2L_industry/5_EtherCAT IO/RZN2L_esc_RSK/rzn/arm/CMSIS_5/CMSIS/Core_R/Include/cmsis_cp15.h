...
{
  uint32_t result;
//  __ASM volatile("MRC p15, 0, %0, c12, c12, 0" : : "r"(result) : :  "memory")
...
{
//  __ASM volatile("MCR p15, 0, %0, c12, c12, 1" : : "r"(value) : "memory")
...
{
  uint32_t result;
//  __ASM volatile("MRC p15, 0, %0, c4, c6, 0" : : "r"(result) : :  "memory")
...
{
//  __ASM volatile("MCR p15, 0, %0, c4, c6, 1" : : "r"(value) : "memory")
...
{
  uint32_t result;
//  __ASM volatile("MRC p15, 0, %0, c12, c11, 3" : : "r"(result) : :  "memory")
...
{
  uint32_t result;
//  __ASM volatile("MRC p15, 0, %0, c12, c12, 3" : : "r"(result) : :  "memory")
...
{
//  __ASM volatile("MCR p15, 0, %0, c12, c12, 3" : : "r"(value) : "memory")
...
{
  uint32_t result;
//  __ASM volatile("MRC p15, 0, %0, c12, c12, 2" : : "r"(result) : :  "memory")

...
#if 1 /* Renesas EIP Sample : CT18.1 Error "Invalid data size: SendRRData reported item count: 4, but not enough data returned for actual item." */ 
  int j = 1; /* allocate 2nd sockaddr */
...
#if 0 /* Renesas EIP Sample : CT18.1 Error "Did not receive T->O I/O packets *** ms after packet with Sequence Number 0! Time since last HeartBeat *** ms." */
  connection_object->eip_level_sequence_count_producing++;
#endif
...
#if 1 /* Renesas EIP Sample : CT18.1 Error "Did not receive T->O I/O packets *** ms after packet with Sequence Number 0! Time since last HeartBeat *** ms." */
  connection_object->eip_level_sequence_count_producing++;
#endif

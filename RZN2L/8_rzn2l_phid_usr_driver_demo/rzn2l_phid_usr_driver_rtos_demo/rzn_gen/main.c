...
#include "task.h"
#include "semphr.h"
extern void phidEvent_thread_create(void);
extern TaskHandle_t phidEvent_thread;
extern void testPhid_thread_create(void);
extern TaskHandle_t testPhid_thread;
...
int main(void)
{
    ...
    /* Init RTOS tasks. */
    phidEvent_thread_create ();
    testPhid_thread_create ();

...
#define BSP_PRV_MASTER_MPU_ENDADD(master, region)    (BSP_CFG_MPU ## master ## _ENDADD ## region)
  ...
  #define BSP_PRV_SECTION_USER_PRG_ROM_ATCM_ADDRESS                &_matcm_text
  #define BSP_PRV_SECTION_USER_PRG_RAM_ATCM_START                  &_atcm_text_start
  #define BSP_PRV_SECTION_USER_PRG_RAM_ATCM_END                    &_atcm_text_end

  #define BSP_PRV_SECTION_USER_DATA_ROM_ATCM_ADDRESS               &_matcm_data
  #define BSP_PRV_SECTION_USER_DATA_RAM_ATCM_START                 &_atcm_data_start
  #define BSP_PRV_SECTION_USER_DATA_RAM_ATCM_END                   &_atcm_data_end
#endif

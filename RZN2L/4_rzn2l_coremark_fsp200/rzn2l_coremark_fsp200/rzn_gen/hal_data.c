...
const gpt_extended_cfg_t g_timer0_extend =
    ...
    .count_down_source   = (gpt_source_t) (((GPT_PHASE_COUNTING_MODE_1_UP | (GPT_PHASE_COUNTING_MODE_1_DN << 16)) & 0xFFFF0000U) >> 16),
				...
				.capture_a_ipl = (BSP_IRQ_DISABLED), .capture_b_ipl =
						(BSP_IRQ_DISABLED),
...
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts =
		(uint32_t) 0x61a80, .duty_cycle_counts = 0x30d40, .source_div =
		(timer_source_div_t) 0, .channel = GPT_CHANNEL_UNIT0_0, .p_callback =
		g_timer0CB, .p_context = NULL, .p_extend = &g_timer0_extend,
		.cycle_end_ipl = (12),
...
/* Baud rate calculated with 0.160% error. */.baudrate_bits_b.abcse = 0,
		...
		.baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 51,
...
const sci_uart_extended_cfg_t g_uart0_cfg_extend = {
		...
		.rs485_setting = { .enable = SCI_UART_RS485_DISABLE, .polarity =
				SCI_UART_RS485_DE_POLARITY_HIGH, .assertion_time = 1,
				.negation_time = 1, }, };
...
const uart_cfg_t g_uart0_cfg = { .channel = 0, .data_bits = UART_DATA_BITS_8,
		...
		.p_transfer_rx = g_uart0_P_TRANSFER_RX, .rxi_ipl = (12),

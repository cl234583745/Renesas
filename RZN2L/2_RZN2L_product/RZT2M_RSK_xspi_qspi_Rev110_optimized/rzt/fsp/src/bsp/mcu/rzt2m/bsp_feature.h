...
#define BSP_FEATURE_BSP_AFMT_SUPPORTED                    (0U)
#define BSP_FEATURE_BSP_BISS_SUPPORTED                    (0U)
#define BSP_FEATURE_BSP_CPU1_SUPPORTED                    (1U)
#define BSP_FEATURE_BSP_ENCOUT_SUPPORTED                  (0U)
#define BSP_FEATURE_BSP_ENDAT_SUPPORTED                   (0U)
#define BSP_FEATURE_BSP_HDSL_SUPPORTED                    (0U)
...
#define BSP_FEATURE_ICU_ERROR_CPU1_SUPPORTED              (1U)

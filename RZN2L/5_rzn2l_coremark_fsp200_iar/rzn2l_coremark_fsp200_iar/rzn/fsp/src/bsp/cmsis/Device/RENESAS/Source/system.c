...
#if FSP_XSPI0_BOOT_SRAM_ATCM
  #define BSP_PRV_SECTION_USER_PRG_ROM_ATCM_ADDRESS                __section_begin("USER_PRG_ATCM_RBLOCK")
  #define BSP_PRV_SECTION_USER_PRG_RAM_ATCM_START                  __section_begin("USER_PRG_ATCM_WBLOCK")
  #define BSP_PRV_SECTION_USER_PRG_RAM_ATCM_END                    __section_end("USER_PRG_ATCM_WBLOCK")
#endif
...
#if FSP_XSPI0_BOOT_SRAM_ATCM
  #define BSP_PRV_SECTION_USER_DATA_ROM_ATCM_ADDRESS               __section_begin("USER_DATA_ATCM_RBLOCK")
  #define BSP_PRV_SECTION_USER_DATA_RAM_ATCM_START                 __section_begin("USER_DATA_ATCM_WBLOCK")
  #define BSP_PRV_SECTION_USER_DATA_RAM_ATCM_END                   __section_end("USER_DATA_ATCM_WBLOCK")
#endif
...
#if FSP_XSPI0_BOOT_SRAM_ATCM
  #define BSP_PRV_SECTION_USER_DATA_BSS_ATCM_START                 __section_begin("USER_DATA_ATCM_ZBLOCK")
  #define BSP_PRV_SECTION_USER_DATA_BSS_ATCM_END                   __section_end("USER_DATA_ATCM_ZBLOCK")
#endif
...
/** @} (end addtogroup BSP_MCU) */
  ...
  #pragma section="USER_PRG_ATCM_RBLOCK"
  #pragma section="USER_PRG_ATCM_WBLOCK"
  #pragma section="USER_DATA_ATCM_RBLOCK"
  #pragma section="USER_DATA_ATCM_WBLOCK"
  #pragma section="USER_DATA_ATCM_ZBLOCK"
...
void bsp_copy_to_ram (void)
{
...
#if FSP_XSPI0_BOOT_SRAM_ATCM
    /* Copy user atcm program block */
    src  = (uintptr_t *) BSP_PRV_SECTION_USER_PRG_ROM_ATCM_ADDRESS;
    dst  = (uintptr_t *) BSP_PRV_SECTION_USER_PRG_RAM_ATCM_START;
    size = (uintptr_t) BSP_PRV_SECTION_USER_PRG_RAM_ATCM_END - (uintptr_t) BSP_PRV_SECTION_USER_PRG_RAM_ATCM_START;
    bsp_copy_multibyte(src, dst, size);
#endif
...
#if FSP_XSPI0_BOOT_SRAM_ATCM    
    /* Copy user atcm data block */
    src  = (uintptr_t *) BSP_PRV_SECTION_USER_DATA_ROM_ATCM_ADDRESS;
    dst  = (uintptr_t *) BSP_PRV_SECTION_USER_DATA_RAM_ATCM_START;
    size = (uintptr_t) BSP_PRV_SECTION_USER_DATA_RAM_ATCM_END - (uintptr_t) BSP_PRV_SECTION_USER_DATA_RAM_ATCM_START;
    bsp_copy_multibyte(src, dst, size);
#endif
    ...
    size = (uintptr_t) BSP_PRV_SECTION_USER_DATA_NONCACHE_RAM_END - (uintptr_t) BSP_PRV_SECTION_USER_DATA_NONCACHE_RAM_START;
    bsp_copy_multibyte(src, dst, size);
}
...
#if FSP_XSPI0_BOOT_SRAM_ATCM    
    /* Clear application atcm bss block. */
    src  = (uintptr_t *) BSP_PRV_SECTION_USER_DATA_BSS_ATCM_START;
    size = (uintptr_t) BSP_PRV_SECTION_USER_DATA_BSS_ATCM_END - (uintptr_t) BSP_PRV_SECTION_USER_DATA_BSS_ATCM_START;
    bsp_bss_init_multibyte(src, size);
#endif
}
